...
namespace SurfNet.CGAL
{

//    public partial static class Utils {
////        inline void* _clean_pointer(const void* p)
////{
 
////}

////    public  void* _set_lsb(const void* p)
////    {
////        const size_t mask = 1;
...
//     * Base vertex class.
//     */
//    public  class Arr_vertex_base<Point> {
...
//        protected object p_pt;  // The point associated with the vertex.
//        protected Arr_parameter_space pss[]=new Arr_parameter_space[2];  // The x and y parameter spaces (condensed in two bytes).

//public
///*! Default constructor. */
//public Arr_vertex_base() :
//    p_inc(null),
//    p_pt(null)
...
//        public void set_point(Point p) { p_pt = p; }

//        /*! Obtain the boundary type in x. */
//        public Arr_parameter_space parameter_space_in_x() 
//  { return (Arr_parameter_space(pss[0])); }

//    /*! Obtain the boundary type in y. */
//    public Arr_parameter_space parameter_space_in_y() 
...
//public virtual void assign(const Arr_vertex_base<Point> v)
//  {
//    p_pt = v.p_pt;
//    pss[0] = v.pss[0];
//    pss[1] = v.pss[1];
...
// * Base halfedge class.
// */
//public class class Arr_halfedge_base<X_monotone_curve> {
...
//    protected void p_v;    // The incident vertex (the target of the halfedge).
//                            // The LSB of this pointer is used to store the
//                            // direction of the halfedge.
//    protected void p_comp; // The component this halfedge belongs to: the incident
...
//    public X_monotone_curve curve() const
//  {
//    assert(p_cv != null);
//    return (*p_cv);
//  }
...
//    Arr_halfedge_base<X_monotone_curve> opp =  Arr_halfedge_base<X_monotone_curve> (p_opp);
...
//    protected int                          flags;      // Face flags.

//    protected  /* Outer_ccbs_container*/ List<object>         outer_ccbs; // The outer CCBs of the faces.

//    protected  /* Inner_ccbs_container*/ List<object>     inner_ccbs; // The inner CCBs of the face.

//    protected /*  Isolated_vertices_container*/ List<object>  iso_verts;  // The isolated vertices inside
//                                                                          // the face.

//    /*! Default constructor. */
//    public Arr_face_base()  { flags=0 }


//    /*! Check if the face is unbounded. */
//    public bool is_unbounded() { return ((flags & (int)Flags.IS_UNBOUNDED) != 0); }

///*! Set the face as bounded or unbounded. */
//public void set_unbounded(bool unbounded)
//  { flags = (unbounded) ? (flags | (int).Flags.IS_UNBOUNDED) : (flags & ~(int)IS_UNBOUNDED); }

//  /*! Check if the face is fictitious. */
// public  bool is_fictitious() { return ((flags & (int).Flags.IS_FICTITIOUS) != 0); }

//    /*! Set the face as fictitious or valid. */
//    public void set_fictitious(bool fictitious)
//  { flags = (fictitious) ? (flags | (int)Flags.IS_FICTITIOUS) : (flags & ~(int)Flags.IS_FICTITIOUS); }

//  /*! Assign from another face. */
//  virtual void assign(Arr_face_base f) { flags = f.flags; }
//};
...
//    public Halfedge halfedge() const
//  {
//    assert(! is_isolated());
...
//    public void set_halfedge(Halfedge* he)
//  {
...
//    public Isolated_vertex isolated_vertex() const
//  {
//    assert(is_isolated());
...
//    public Isolated_vertex isolated_vertex()
//  {
//    assert(is_isolated());
...
//    public void set_isolated_vertex(Isolated_vertex iv)
//  {
...
//public:
//  /*! Default constructor. */
//  Arr_inner_ccb() : status(ITER_IS_SINGULAR) { f_or_icc.f = null; }
