namespace SurfNet
{
    ...
    {
        public List<HeapItemBase<PriorityType>> v_;
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    if (lp.CompareTo(orig_root.priority) == (int)ESign.SMALLER)
                    {
                        ...
                        //);
                        smallest = (lp.CompareTo(rp) <= (int)ESign.EQUAL) ? left : right;
                    }
                    else
                    {
                        /* STATS_STMT(*/
...
//                /*STATS_STMT(*/
//                { if (lp.Equals(orig_root.priority)) ++heap_eq_ctr; }/*)*/;
//                if (lp.CompareTo(orig_root.priority) == (int)Tools.SMALLER)
//                {
//                    smallest = left;
//                }
//                else
...
//                    { if (lp.Equals(rp)) ++heap_eq_ctr; }
//                    //);
//                    smallest = (lp.CompareTo(rp) <= (int)Tools.ZERO) ? left : right;
//                }
//                else
//                {
//                    /* STATS_STMT(*/
