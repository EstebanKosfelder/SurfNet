...
namespace SurfNet
{
    ...
    {
        public int original_vertex_idx = -1;

        public BasicVertexInfo()
        {
        }
    };
    public struct BasicFaceInfo
    {
        public int component = -1;
        public bool queued_potential_components = false; /** true if we have visited a neighbor across a constraint. */
        public bool queued_this_component = false;

        public BasicFaceInfo()
        {

        }

        /** true if we have ever visited a neighbor across a triangulation edge.
                                               So it's either queued for the current of a previous component. */
        public bool matches_component(int q)
        {
    ...
    public class BasicTriangulation
    {
        ...
        public bool consistent_sidedness;
        public int max_component_ = -1;
         ...
         */
        //    public void tag_components(Vertex_handle v0, Vertex_handle v1);

        /* Initialize the constrained triangulation.
         */
        public void initialize(BasicInput input) { }
        public int max_component() { return max_component_; }
        public IEnumerable<Face> Faces => throw new NotImplementedException();
        ...
        //                            { /* already handled, or it's part of this component also and has not been handled */
